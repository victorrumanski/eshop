...
import com.rumanski.ordering.es.events.OrderingDomainEvent;
import com.rumanski.ordering.es.events.OrderingDomainEvent.EventType;

@Component
/*
 * This class will only log messages from kafka
 */
public class OrderingKafkaConsumer {

	private static final Logger LOGGER = LoggerFactory.getLogger(OrderingKafkaConsumer.class);
	...
	private static class ConsumerLoop {
		...
		public void loop() {
			...
			EventType[] values = OrderingDomainEvent.EventType.values();
