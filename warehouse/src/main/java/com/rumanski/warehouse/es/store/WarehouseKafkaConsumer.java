...
import com.rumanski.warehouse.es.events.WarehouseDomainEvent;
import com.rumanski.warehouse.es.events.WarehouseDomainEvent.EventType;
...
public class WarehouseKafkaConsumer {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(WarehouseKafkaConsumer.class);
	...
	private static class ConsumerLoop {
		...
		public void loop() {
			...
			EventType[] values = WarehouseDomainEvent.EventType.values();
